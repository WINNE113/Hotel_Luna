                            ...
                            <div class="filter_layout">
                                ...
                                <div class="sub_filter">
                                    <div class="title_filter">
                                        <span>Price</span>
                                        <div>
                                            <input type="Checkbox" name="price" id="" value="0,50000">
                                            <label for="price"> 0$ - 50000$</label>
                                        </div>
                                        <div>
                                            <input type="Checkbox" name="price" id="" value="50000,100000">
                                            <label for="price"> 50000$ - 100000$</label>
                                        </div>
                                        <div>
                                            <input type="Checkbox" name="price" id="" value="100000,200000">
                                            <label for="price"> 100000$ - 200000$</label>
                                        </div>
                                        <div>
                                            <input type="Checkbox" name="price" id="" value="200000,5000000">
                                            <label for="price"> 200000$ +</label>
                                        </div>
                                ...
                                <div class="sub_filter">
                                    <div class="title_filter">
                                        <span>Room type</span>
                                        <div>
                                            <input type="radio" name="type_room" id="" value="President">
                                            <label for="type_room">President</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="type_room" id="" value="Superior">
                                            <label for="type_room">Superior</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="type_room" id="" value="Executive">
                                            <label for="type_room">Executive</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="type_room" id="" value="Standard">
                                ...
                                <div class="sub_filter">
                                    <div class="title_filter">
                                        <span>Bed type</span>
                                        <div>
                                            <input type="radio" name="type_bed" id="" value="Double">
                                            <label for="type_bed_1">Double</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="type_bed" id="" value="Queen">
                                            <label for="type_bed_2">Queen</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="type_bed" id="" value="Single">
                                ...
                                <div class="sub_filter">
                                    <div class="title_filter">
                                        ...
                                        <div>
                                            <input type="radio" name="start_rating_1" id="start_rating_1" value="">
                                            <label for="start_rating_1">5 sao</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="start_rating_2" id="start_rating_2" value="">
                                            <label for="start_rating_2">4 sao</label>
                                        </div>
                                        <div>
                                            <input type="radio" name="start_rating_3" id="start_rating_3" value="">
                                            <label for="start_rating_3">3 sao</label>
                                        </div>
                                        <div>

                                            <input type="radio" name="start_rating_4" id="start_rating_4" value="">
                                            <label for="start_rating_4">2 sao</label>
                                        </div>
                                        <div>

                                            <input type="radio" name="start_rating_5" id="start_rating_5" value="">
