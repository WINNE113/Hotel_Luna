 ...
 */
package Entites.CustomerEntity;
...
public class Guest {
    ...
    public String toString() {
        return "Guest{" + "guestId=" + guestId + ", firstName=" + firstName + ", lastName=" + lastName + ", dob=" + dob + ", gen=" + gen + ", phone=" + phone + ", email=" + email + ", passWord=" + passWord + ", passPortNo=" + passPortNo + ", address=" + address + ", isMemberShip=" + isMemberShip + '}';
    }
