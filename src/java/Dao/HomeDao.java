...
public class HomeDao {
    ...
    public List<RoomDetail> getTop4Room() {
        String query = "select top 4 c.CityName, h.HotelAddress, r.RoomTypeName, rt.RoomPrice, rt.RoomImg, rr.RoomRateDesc\n"
        ...
        try {
            ...
            while (rs.next()) {
                RoomDetail detail = new RoomDetail(rs.getString(1),
                        rs.getString(2),
                        rs.getString(3),
                        rs.getDouble(4),
                        rs.getString(5),
